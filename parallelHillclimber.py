...
class PARALLEL_HILL_CLIMBER():
    ...
    def Write_Statistics(self):
        ...
        bestSol = max(list(self.parents.values()), key=lambda x: x.fitness)
        # I spent time trying to figure out how to combine these two. It didn't work
        np.save("best_controller_STH.npy", np.asarray(bestSol.sensors_to_hidden))
        np.save("best_controller_HTM.npy", np.asarray(bestSol.hidden_to_motors))
